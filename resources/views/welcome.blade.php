...
<div class="relative min-h-screen bg-white overflow-hidden">
    <div class="max-w-screen-xl h-screen mx-auto ">
        <div class="relative h-screen z-10 bg-white lg:max-w-2xl lg:w-full">
                ...
                <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
                    <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                        <div class="flex items-center justify-between w-full md:w-auto">
                            <a href="/">
                                <x-logos.wordmark class="w-16 h-16 text-red-500" />
                            </a>
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4">
                        ...
                        <a href="#"
                            class="ml-8 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Marketplace</a>
                        <a href="#"
                            class="ml-8 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Company</a>
                        <a href="#"
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-green-300">
        <div class="w-full grid grid-cols-6 gap-2" style="transform: rotate(5deg) translateY(-100px);">
            @foreach((new App\Deck(2, 'normal-with-jokers'))->cards as $card)
            <x-card :card="$card" :key="$loop->index" class="card" />
            @endforeach
        </div>
        <div class="w-full h-full absolute inset-0"
            style="background: linear-gradient(to right, rgba(61,64,91,.2), rgb(254,253,237,.2));"></div>
    </div>
</div>
@endsection